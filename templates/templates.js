...
export const templates = {
  ...
  "workflow-publish-and-deploy": {
    title: "Github Workflow - Publish and deploy",
    source: "../templates/github-workflows-publish-and-deploy.yaml.tpl",
    target: "./.github/workflows/publish-and-deploy.yaml",
  },
  "vs-code-settings": {
